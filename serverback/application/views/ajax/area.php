	...
	<div class="col-md-12">					
		<div class="card" >                            
			<div class="card-body">
				...
				<div class="form-group">
					<label for="type" class="col-md-3 col-xs-12 col-form-label">Tipo *:
					<h6>Por favor escoja el tipo de área</h6></label>
					<div class="col-12">						
						<?= form_dropdown('type', $types, $datos['type'],"class = form-control");?>
					</div>
				</div>
