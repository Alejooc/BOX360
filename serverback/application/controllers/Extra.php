...
class Extra extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('model_extra','model');		
	...
	public function get_form(){
		...
		if($this->input->post("id")>0){
			...
			$data['datos'] = $user;
			$data['datos']['employeen']=$this->model->get_employeen($user['employee']);
		}
		$data['destinysd']=$this->model->get_destinyd();
	...
	public function form_send($type){
		...
		$this->form_validation->set_rules('destinyd', 'Destino', 'required');
